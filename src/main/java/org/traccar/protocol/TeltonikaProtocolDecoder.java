...
public class TeltonikaProtocolDecoder extends BaseProtocolDecoder {
    ...
    private static final Map<Integer, Map<Predicate<String>, BiConsumer<Position, ByteBuf>>> PARAMETERS = new HashMap<>();
    ...
    static {
        ...
        register(84, fmbXXX.and(fmb6XX.negate()), (p, b) -> p.set(Position.KEY_FUEL_LEVEL, b.readUnsignedShort() * 0.1));
        ...
        register(303, fmbXXX, (p, b) -> p.addAlarm(b.readUnsignedByte() > 0 ? Position.ALARM_VIBRATION : null));
